	...
	<div class="login">
		...
		<div class="main-agileits">
				<div class="form-w3agile">
					...
					<form class="login-form text-center" action="forgot_process.php" method="post">
			<div class="form-group">
				<input type="email" class="form-control rounded-pill form-control-lg" placeholder="Enter Email id" name='u_email' required>
			</div>
			

			<input type="submit" class="btn btn-success mb-5 btn-block rounded-pill form-control-lg" value="Click Me" name="login">
		</form>
				</div>
